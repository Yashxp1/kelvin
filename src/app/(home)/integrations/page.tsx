        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {items.map((item) => {
            ...
            return (
              ...
              >
                <div>
                  <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-lg border border-zinc-200 bg-zinc-50 text-zinc-900">
                    <item.icon size={20} />
                  </div>
                ...
                <div className="mt-8">
                  {loading ? (
                    ...
                    <div className="flex h-10 w-full items-center justify-center rounded-md bg-zinc-100 text-sm font-medium text-zinc-500">
                      Coming Soon
                    </div>
                  ) : isConnected ? (
                    <Button
