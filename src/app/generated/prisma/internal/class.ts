...
/**
  ...
  /**
   * `prisma.aI_Response`: Exposes CRUD operations for the **AI_Response** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more AI_Responses
    * const aI_Responses = await prisma.aI_Response.findMany()
    * ```
    */
  get aI_Response(): Prisma.AI_ResponseDelegate<ExtArgs, { omit: OmitOpts }>;
}
